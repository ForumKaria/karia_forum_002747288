...
public class MagazineDirectory {
    ...
    public Magazine addMagazine(String name, Date date, String company, String issueType, Float price){
        Magazine mag = new Magazine(name, date, company, issueType, price);
